  ...
  <div class="col-md-3">
	...
	if(isset($_POST['fullname'])) {
		...
		if($fullname == "" || $fullname== NULL) {
			header("location:editthread.php?error=Must input full name!");
		} 
		else {
    ...
    <tbody>
            ...
            <td><a href="viewthreadlist.php?id=<?php echo $result['id']?>"><button class="btn btn-info" type="button" method="post">View Thread List</button></a></td>
